...
"true"		{ return new_symbol(sym.TRUEFALSE, true); }
"false"		{ return new_symbol(sym.TRUEFALSE, false); }
...
"["			{ return new_symbol(sym.LUPAR, yytext()); }
"]"			{ return new_symbol(sym.RUPAR, yytext()); }
